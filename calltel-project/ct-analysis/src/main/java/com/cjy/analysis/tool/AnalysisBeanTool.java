...
import com.cjy.analysis.map.AnalysisBeanMap;
import com.cjy.analysis.map.AnalysisTextMap;
import com.cjy.analysis.outformat.MysqlBeanRedisCacheOutputFormat;
import com.cjy.analysis.outformat.MysqlRedisCacheOutputFormat;
import com.cjy.analysis.reducer.AnalysisBeanReduce;
...
public class AnalysisBeanTool implements Tool {
    ...
    public int run(String[] args) throws Exception {
         ...
         * job：
         */
        TableMapReduceUtil.initTableMapperJob(Names.TABLE.getValue(),scan, AnalysisBeanMap.class, AnalysisKey.class, AnalysisValue.class,job);

        job.setReducerClass(AnalysisBeanReduce.class);
        job.setOutputKeyClass(AnalysisKey.class);
        job.setOutputValueClass(AnalysisValue.class);
        //写入到mysql 中
//        job.setOutputFormatClass(MysqlTextOutputFormat.class);
        job.setOutputFormatClass(MysqlBeanRedisCacheOutputFormat.class);
